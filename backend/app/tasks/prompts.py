...
## Examples                            (concrete examples from the source material, cited as 'From: <video title>')
## Tips & gotchas
Keep it a fast-recall manual, not an essay."""
...
attributions), add genuinely new steps/flags/tips in place, dedupe, keep the existing
structure and voice. Output the full updated document only."""
